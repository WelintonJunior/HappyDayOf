...
func AtendimentoRoutes(server *gin.Engine) {
	...
	server.POST("/Atendimento/ReadAtendimento", ReadAtendimento)
	server.POST("/Atendimento/RegisterAtendimento", RegisterAtendimento)
	server.POST("/Atendimento/ValidacaoAtendimento", ValidacaoAtendimento)
	server.POST("/Atendimento/UpdateStatusAtendimento", UpdateStatusAtendimento)
...
func AcademiaRoutes(server *gin.Engine) {
	...
	server.POST("/Academia/ReadAcademiaLista", ReadAcademiaLista)
	server.POST("/Academia/CreateAcademia", CreateAcademia)
	server.POST("/Academia/AddAdministrador", AddAdministrador)
	server.POST("/Academia/InsertAcademiaToTheOptions", InsertAcademiaToTheOptions)
}
